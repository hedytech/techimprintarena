    ...
    const Page = () => {
      ...
      return (
        <div>
          <Head>
            <title>Helsinki - Tech Imprint Arena</title>
            <link rel="canonical" href="https://techimprintarena.com/sv/program/helsinki/" />
          </Head>
          <div
          className="bg-cover bg-center h-screen w-screen fixed z-0"
            style={{
              backgroundImage: 'url("/city/helsinki-bw2.jpg")'
            }}
          />
    ...
    export default withLayout(Page, 'sv');
