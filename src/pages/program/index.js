...
const Page = ({ locale, t }) => (
  <div>
    <Head>
      ...
      <link rel='canonical' href={`https://techimprintarena.com/${locale}/program/`} />
    </Head>
    <div
          ...
          {ci % 2 === 0 ? (
            ...
            >
              ...
              <h2 className='text-lg lg:text-5xl font-bold pl-10'>
                ...
                <span className='text-base lg:text-3xl' dangerouslySetInnerHTML={{ __html: c.when.toUpperCase().replace(/TH/g, '<sup>th</sup>').replace(/ND/g, '<sup>nd</sup>') }} />
              </h2>
            </a>
          ) : (
            <a
...
export default withLayout(withTranslation(Page, 'program'));
